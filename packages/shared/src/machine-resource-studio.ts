...
export interface MRSInput { audit: { id: string; domain: string; completedAt: string | null; pageCount: number | null }; scores: MRSInputScore | null; aiVisibility: MRSInputAIVisibility | null; pages: MRSInputPage[]; issues: MRSInputIssue[]; }
