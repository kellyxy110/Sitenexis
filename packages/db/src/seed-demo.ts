...
const demos: DemoSite[] = [
  {
    ...
    aiVisibility: {
      ...
      entityConfidenceScore: 38,
      citationProbabilityScore: 32,
      machineReadabilityScore: 62,
      semanticTrustScore: 48,
      retrievalReadinessScore: 45,
      recommendationConfidenceScore: 28,
    },
  },
  {
    domain: 'alwajudproperties.com',
    pages: [
      { url: 'https://alwajudproperties.com/', statusCode: 200, title: 'Al Wajud Properties - Premium Real Estate in Dubai', metaDescription: 'Al Wajud Properties offers premium residential and commercial real estate in Dubai. Expert guidance for buyers, sellers, and investors.', h1: 'Premium Real Estate in Dubai', canonicalUrl: 'https://alwajudproperties.com/', wordCount: 1850, isIndexable: true, internalLinks: 18, externalLinks: 5, seoScore: 76, aiScore: 70 },
      { url: 'https://alwajudproperties.com/properties', statusCode: 200, title: 'Properties for Sale - Al Wajud Properties', metaDescription: 'Browse luxury apartments, villas, and commercial properties in Dubai Marina, Downtown, Palm Jumeirah, and more.', h1: 'Properties for Sale', canonicalUrl: 'https://alwajudproperties.com/properties', wordCount: 2400, isIndexable: true, internalLinks: 35, externalLinks: 2, seoScore: 72, aiScore: 65 },
      { url: 'https://alwajudproperties.com/about', statusCode: 200, title: 'About Al Wajud Properties', metaDescription: 'Established in 2018, Al Wajud Properties is a RERA-licensed real estate brokerage specializing in Dubai premium properties.', h1: 'About Us', canonicalUrl: 'https://alwajudproperties.com/about', wordCount: 920, isIndexable: true, internalLinks: 8, externalLinks: 6, seoScore: 80, aiScore: 75 },
    ...
    aiVisibility: {
      ...
      entityConfidenceScore: 58,
      citationProbabilityScore: 48,
      machineReadabilityScore: 72,
      semanticTrustScore: 62,
      retrievalReadinessScore: 60,
      recommendationConfidenceScore: 45,
    },
  },
  {
    domain: 'genshipyard.com',
    pages: [
      { url: 'https://genshipyard.com/', statusCode: 200, title: 'GenShipyard - AI Agent Development Platform', metaDescription: 'Build, deploy, and scale AI agents with GenShipyard. The developer platform for autonomous AI systems.', h1: 'Ship AI Agents at Scale', canonicalUrl: 'https://genshipyard.com/', wordCount: 2200, isIndexable: true, internalLinks: 16, externalLinks: 4, seoScore: 82, aiScore: 78 },
      { url: 'https://genshipyard.com/platform', statusCode: 200, title: 'Platform - GenShipyard', metaDescription: 'Agent orchestration, tool integration, memory management, and deployment infrastructure for AI agents.', h1: 'The Complete Agent Platform', canonicalUrl: 'https://genshipyard.com/platform', wordCount: 3100, isIndexable: true, internalLinks: 22, externalLinks: 6, seoScore: 85, aiScore: 80 },
      { url: 'https://genshipyard.com/docs', statusCode: 200, title: 'Documentation - GenShipyard', metaDescription: 'Complete API reference, quickstart guides, and architecture documentation for GenShipyard.', h1: 'Developer Documentation', canonicalUrl: 'https://genshipyard.com/docs', wordCount: 5200, isIndexable: true, internalLinks: 68, externalLinks: 12, seoScore: 88, aiScore: 85 },
      { url: 'https://genshipyard.com/pricing', statusCode: 200, title: 'Pricing - GenShipyard', metaDescription: 'Usage-based pricing for AI agent deployment. Free tier included. Pay per agent execution.', h1: 'Pricing', canonicalUrl: 'https://genshipyard.com/pricing', wordCount: 780, isIndexable: true, internalLinks: 8, externalLinks: 1, seoScore: 75, aiScore: 72 },
      { url: 'https://genshipyard.com/blog', statusCode: 200, title: 'Blog - GenShipyard', metaDescription: 'Technical deep dives on AI agent architecture, LLM orchestration, and autonomous systems.', h1: 'Engineering Blog', canonicalUrl: 'https://genshipyard.com/blog', wordCount: 1200, isIndexable: true, internalLinks: 28, externalLinks: 8, seoScore: 78, aiScore: 75 },
      { url: 'https://genshipyard.com/use-cases', statusCode: 200, title: 'Use Cases - GenShipyard', metaDescription: 'Real-world AI agent deployments: customer support, data pipelines, code review, content generation.', h1: 'Use Cases', canonicalUrl: 'https://genshipyard.com/use-cases', wordCount: 2800, isIndexable: true, internalLinks: 18, externalLinks: 5, seoScore: 80, aiScore: 77 },
      { url: 'https://genshipyard.com/about', statusCode: 200, title: 'About GenShipyard', metaDescription: 'Founded by ex-Google and DeepMind engineers. Building the infrastructure layer for AI agents.', h1: 'About Us', canonicalUrl: 'https://genshipyard.com/about', wordCount: 950, isIndexable: true, internalLinks: 10, externalLinks: 8, seoScore: 78, aiScore: 72 },
    ...
    issues: [
      ...
      { module: 'ai', type: 'entity-consistency', severity: 'info', message: 'Entity "GenShipyard" is consistently described across 7/8 pages (changelog lacks entity context)', recommendation: 'Add brief platform description to changelog page header' },
      ...
      { module: 'citation', type: 'high-factual-density', severity: 'info', message: 'Documentation pages have high factual density — excellent citation eligibility', recommendation: 'Maintain current factual precision; consider adding version-specific dates for temporal freshness' },
      ...
      { module: 'ai', type: 'strong-conversational-readiness', severity: 'info', message: 'Use cases page is well-structured for AI question-answering with clear headings and direct answers', recommendation: 'Consider adding FAQ schema to reinforce AI extraction' },
    ],
    scores: {
      overall: 79,
      seoScore: 80,
    ...
    aiVisibility: {
      ...
      entityConfidenceScore: 72,
      citationProbabilityScore: 68,
      machineReadabilityScore: 82,
      semanticTrustScore: 72,
      retrievalReadinessScore: 75,
      recommendationConfidenceScore: 62,
    },
  },
  {
    domain: 'inforsphere.com',
    pages: [
      { url: 'https://inforsphere.com/', statusCode: 200, title: 'InforSphere - Enterprise Data Intelligence', metaDescription: 'InforSphere delivers enterprise data intelligence solutions: data governance, quality management, and AI-driven insights.', h1: 'Enterprise Data Intelligence', canonicalUrl: 'https://inforsphere.com/', wordCount: 1600, isIndexable: true, internalLinks: 14, externalLinks: 3, seoScore: 70, aiScore: 62 },
      { url: 'https://inforsphere.com/solutions', statusCode: 200, title: 'Solutions - InforSphere', metaDescription: 'Data governance, master data management, data quality, and analytics solutions for enterprise.', h1: 'Our Solutions', canonicalUrl: 'https://inforsphere.com/solutions', wordCount: 2100, isIndexable: true, internalLinks: 20, externalLinks: 4, seoScore: 72, aiScore: 65 },
    ...
    issues: [
      ...
      { module: 'ai', type: 'entity-disambiguation-weak', severity: 'warning', message: '"InforSphere" may conflict with IBM InfoSphere — disambiguation signals are insufficient', recommendation: 'Add explicit "not affiliated with IBM" signal and ensure sameAs links clearly identify this entity' },
      ...
      { module: 'ai', type: 'poor-conversational-readiness', severity: 'warning', message: 'Solutions page uses enterprise jargon without direct answers to common questions', recommendation: 'Add a "What is [solution]?" section at the top of each solution page for AI extraction' },
      { module: 'citation', type: 'missing-case-study-schema', severity: 'warning', message: 'Case studies exist but lack Article schema with specific results and metrics', recommendation: 'Add Article schema and ensure quantified results (% improvement, $ saved) are in plain text' },
    ...
    aiVisibility: {
      ...
      entityConfidenceScore: 52,
      citationProbabilityScore: 42,
      machineReadabilityScore: 68,
      semanticTrustScore: 58,
...
async function seedDemoAudits() {
  ...
  for (const site of demos) {
    // Delete existing demo for this domain
    ...
    await db.auditScore.create({
      data: { auditId: audit.id, ...site.scores },
    });
  ...
  console.log('Done! Demo audits seeded successfully.');
}
