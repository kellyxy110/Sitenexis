...
vi.mock('@sitenexis/db', () => ({
  ...
  getRedLabReport: h.getRedLabReport,
}));
...
beforeEach(() => {
  ...
  h.getRedLabReport.mockResolvedValue({ version: 'redlab-v1', overallScore: 90, scoreBreakdown: {}, exposedPaths: [], vulnerableLibraries: [], pathsChecked: 14, issues: [], limitations: [] });
});

describe('GET /api/audit/[id]/redlab', () => {
